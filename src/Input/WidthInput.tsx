export function WidthInput({setWidth}: {setWidth: React.Dispatch<React.SetStateAction<number>>}) {
  ...
  return (
    <div className="mb-8" onChange={onWidthChange}>
        ...
        <div className="my-5" id="widthInput">
          <div className="inline">
            ...
            <label className="py-3 px-3 mr-3 border-2 border-b-4 border-r-4 border-cyan-900 rounded-md peer-checked:bg-cyan-900 peer-checked:border-cyan-600 hover:bg-neutral-600 hover:border-gray-400" htmlFor="sm">266 px</label>
          </div>
          <div className="inline">
            <input className="hidden peer" type="radio" id="md" value={586} name="width" />
            <label className="py-3 px-3 mr-3 border-2 border-b-4 border-r-4 border-cyan-900 rounded-md peer-checked:bg-cyan-900 peer-checked:border-cyan-600 hover:bg-neutral-600 hover:border-gray-400" htmlFor='md'>586 px</label>
          </div>
          <div className="inline">
